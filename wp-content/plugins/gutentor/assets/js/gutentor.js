(function ($) {
    ...
    function gCountUp(gThis) {
        let startValue = parseInt(gThis.data('start')),
            ...
            nCountUp = new CountUp(this, startValue, endValue, 0, duration);
    ...
    gDocument.on('click', '.gutentor-filter-navigation .gutentor-filter-item>a', function (e) {
        ...
        gThis.parent().siblings().removeClass('gutentor-filter-item-active');
        ...
        * https://github.com/imakewebthings/waypoints*/
        ...
        if (typeof $.fn.AcmeTicker !== 'undefined') {
            $('.gutentor-post-module-p5').each(function () {
                ...
                let news_ticker_data = this_newsTicker.find('.gutentor-news-ticker-data'),
