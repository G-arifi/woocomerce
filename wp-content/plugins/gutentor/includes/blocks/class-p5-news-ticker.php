...
if (!class_exists('Gutentor_P5_NewsTicker')) {
     ...
     *
     */
    class Gutentor_P5_NewsTicker extends Gutentor_Block_Base
    {
        ...
        public function load_dependencies()
        {
            ...
            require_once GUTENTOR_PATH . 'includes/block-templates/p5-news-ticker/class-p5-news-ticker-templates.php';
        }
            ...
            if ($the_query->have_posts()) :
                ...
                if ($attributes['p5OnControl']) {
                    ...
                    if ($attributes['p5Type'] !== 'marquee') {
                        $output .= '<span class="gutentor-news-ticker-arrow gutentor-news-ticker-prev"></span>';
                    }
                    $output .= '<span class="gutentor-news-ticker-action gutentor-news-ticker-pause"></span>';
                    if ($attributes['p5Type'] !== 'marquee') {
                        $output .= '<span class="gutentor-news-ticker-arrow gutentor-news-ticker-next"></span>';
                    }
...
Gutentor_P5_NewsTicker::get_instance()->run();