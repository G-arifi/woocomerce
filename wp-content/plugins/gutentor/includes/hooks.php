...
class Gutentor_Hooks {
	...
	function customize_register( $wp_customize ) {
        ...
        $wp_customize->add_setting( 'gutentor_force_load_block_assets', array(
            'type'             => 'option',
            'default'			=> $defaults['gutentor_force_load_block_assets'],
            'sanitize_callback' => 'gutentor_sanitize_checkbox'
        ) );
        $wp_customize->add_control( 'gutentor_force_load_block_assets', array(
        ...
        if( $categories ){
            foreach ($categories as $category_list) {
                ...
                $wp_customize->add_setting('gutentor-cat-' . $category_list->term_id . '', array(
                    'type'             => 'option',
        ...
        if ( is_array( $post_formats[0] ) ) {
            ...
            $wp_customize->add_section( 'gutentor-theme-post-format-options', array(
                'priority'          => 30,
                'capability'        => 'edit_theme_options',
            ...
            foreach ($post_formats as $post_format) {
                ...
                $wp_customize->add_setting('gutentor-pf-' . esc_attr($post_format) . '', array(
                    'type'             => 'option',
                    'sanitize_callback' => 'gutentor_sanitize_field_background',
                    'default'           =>'',
                ));
    ...
    function load_last_scripts(){
        ...
        wp_localize_script( 'gutentor-block', 'gutentorLS', array(
